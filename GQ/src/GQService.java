...
public class GQService {
    ...
    private void step1() throws IllegalAccessException {
        ...
        System.out.printf("""
                ...
                Calculó T = %d y lo envió a Victor
    ...
    private void step2() throws IllegalAccessException {
        ...
        System.out.printf("""
                \n--- Paso 2 ---
                Victor eligió un número aleatorio d = %d y se lo envió a Peggy
    ...
    private void step3() throws IllegalAccessException {
        ...
        System.out.printf("""
                \n--- Paso 3 ---
                Peggy calculó D = %d y se lo envió a Victor
    ...
    private void step4() throws IllegalAccessException {
        ...
        if (!victor.getT().equals(victor.getT_())) {
            throw new IllegalAccessException("La autenticidad de Peggy no está probada, ya que T' != T\nT = " + victor.getT() + ", T' = " + victor.getT_());
        }
        System.out.printf("""
                \n--- Paso 4 ---
                Victor calculó T' = %d.
                T' = T, por lo tanto, la autenticidad de Peggy está probada.
